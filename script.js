...
function getPortfolioItems(lang) {
  ...
  return [
    ...
    },
    {
      ...
      type: 'video',
      category: 'works',
      src: 'public/videos/soundcore.mp4',
      title: t.item2Title,
